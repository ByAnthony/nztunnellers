...
const component = (
  <NextChapterButton chapter={mockNextButton} />
);
...
test('renders next chapter button correctly', () => {
  ...
  expect(screen.getByRole('link')).toHaveAttribute('href', '/history/my-path-to-next-chapter/');
...
test('do not render next chapter button if null', () => {
  const { container } = render(
    <NextChapterButton chapter={undefined} />,
  );
