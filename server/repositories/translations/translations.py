attached_corps_col = {'en': 'attached_corps.corps_en',
...
medal_citation_col = {
    'en': 'medal_citation.medal_citation_en', 'fr': 'medal_citation.medal_citation_fr'}


medal_name_col = {
    'en': 'medal.medal_name_en', 'fr': 'medal.medal_name_fr'}
...
training_location_type_col = {'en': 'training_location_type.training_location_type_en',
