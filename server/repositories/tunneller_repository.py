...
def show(id, mysql):
    sql = f'''
        ...
        LEFT JOIN london_gazette london_gazette_1 ON t.london_gazette_1_fk=london_gazette_1.london_gazette_id
        LEFT JOIN london_gazette london_gazette_2 ON t.london_gazette_2_fk=london_gazette_2.london_gazette_id
        LEFT JOIN london_gazette london_gazette_3 ON t.london_gazette_3_fk=london_gazette_3.london_gazette_id
        LEFT JOIN london_gazette london_gazette_4 ON t.london_gazette_4_fk=london_gazette_4.london_gazette_id
