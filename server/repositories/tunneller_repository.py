...
def show(id, mysql):
    sql = f'''
        ...
        JOIN london_gazette_join ON t.id=london_gazette_join.london_gazette_t_id
        JOIN london_gazette ON london_gazette.london_gazette_id=london_gazette_join.london_gazette_lg_id
