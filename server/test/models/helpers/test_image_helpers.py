...
def test_get_image_if_url_and_source_exist():
    assert get_image(
...
def test_get_image_source_book_with_page():
...
def test_get_image_source_book_with_no_page():
    assert get_image_source_book(
