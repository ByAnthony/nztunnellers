from ....models.helpers import formatter_nominal_roll
...
def test_if_volume_and_roll_are_not_none_and_lang_en_returns_nominal_roll():
    assert formatter_nominal_roll.format_nominal_roll(volume, roll, page, en) == {
        'title': title_1919[en],
        'town': 'Wellington',
...
def test_if_volume_and_roll_are_not_none_and_lang_fr_returns_nominal_roll():
    assert formatter_nominal_roll.format_nominal_roll(volume, roll, page, fr) == {
        'title': title_1919[fr],
        'town': 'Wellington',
        'publisher': 'Government Printer',
        'date': '1914-1919',
...
def test_if_volume_and_roll_are_none_and_lang_en_returns_nominal_roll():
    assert formatter_nominal_roll.format_nominal_roll(None, None, page, en) == {
        'title': title_1916[en],
        'town': 'Wellington',
        'publisher': 'Government Printer',
        'date': '1916',
...
def test_if_volume_and_roll_are_none_and_lang_fr_returns_nominal_roll():
    assert formatter_nominal_roll.format_nominal_roll(None, None, page, fr) == {
        'title': title_1916[fr],
        'town': 'Wellington',
        'publisher': 'Government Printer',
        'date': '1916',
