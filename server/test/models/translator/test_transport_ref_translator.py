# -*- coding: utf-8 -*-
# from ....models.helpers import translator_transport_ref
...
#     assert (
#         translator_transport_ref.translate_transport_ref(transport_ruapehu, "fr")
...
#     assert (
#         translator_transport_ref.translate_transport_ref(transport_ruapehu, "en")
#         == transport_ruapehu
#     )
...
#     assert (
#         translator_transport_ref.translate_transport_ref(transport_hmnzs, "en")
#         == transport_hmnzs
#     )
...
#     assert (
#         translator_transport_ref.translate_transport_ref(transport_hmnzs, "fr")
#         == transport_hmnzs
#     )
