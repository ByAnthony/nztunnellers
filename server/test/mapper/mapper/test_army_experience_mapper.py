...
experience_en = ({'army_experience_name': 'Garrison Artillery Volunteers',
                  'country': 'New Zealand', 'conflict_name': None, 'army_experience_in_month': 12},
                 {'army_experience_name': None,
                  'country': None, 'conflict_name': 'South African War', 'army_experience_in_month': 250})
experience_fr = ({'army_experience_name': 'National Reserve',
                  'country': 'Nouvelle-Zélande', 'conflict_name': 'Guerre d\'Afrique du Sud', 'army_experience_in_month': 50},)
