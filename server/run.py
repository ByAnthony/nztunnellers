...
def tunneller(id):
    ...
    tunneller, medals, nz_archives, london_gazette, image_source_book_authors = tunneller_repository.show(
        id, lang, mysql)
    return jsonify(map_tunneller(tunneller, medals, nz_archives, london_gazette, image_source_book_authors))
